            ...
            <div class="row">
              ...
              >
                ...
                @endforeach
                    ...
                    <div
                    class="item col-md-4 mb30 gallery-item undiksha"
                    data-value="project-details-image.html"
                    >
                    <a
                        class="picframe"
                        href="{{ asset('images/portfolio/brektortundks.jpeg') }}"
                        title="Spanduk Visitasi AQAS Undiksha"
                        data-source="#"
                    >
                        <span class="overlay">
                        <span class="d-title"
                            >Spanduk Visitasi AQAS Undiksha</span
                        >
                        </span>

                        <img src="{{ asset('images/portfolio/brektortundks.jpeg') }}" alt="" />
                    </a>
                    </div>
                  ...
                  <div
                    class="item col-md-4 mb30 gallery-item photography videography"
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/portfolio/encoremall.jpeg') }}"
                      title="モールで Coswalk Competition"
                      data-source="https://www.instagram.com/reel/Cp8P9goAgAl/"
                    >
                      <span class="overlay">
                        <span class="d-title"
                          >モールで Coswalk Competition</span
                        >
                      </span>

                      <img src="{{ asset('images/portfolio/encoremall.jpeg') }}" alt="" />
                    </a>
                  </div>
                  ...
                  <div class="item col-md-4 mb30 gallery-item photography">
                    <a
                      class="picframe"
                      href="{{ asset('images/portfolio/stsby1.png') }}"
                      title="STSBY Kesanga"
                      data-source="#"
                    >
                      <span class="overlay">
                        <span class="d-title">STSBY Kesanga</span>
                      </span>

                      <img src="{{ asset('images/portfolio/stsby1.png') }}" alt="" />
                    </a>
                  </div>
                  ...
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/portfolio/crehaprojects.jpg') }}"
                      title="Dokumentasi Hajimari no Recreate"
                      data-source="https://www.instagram.com/p/Cg1XoBSLblZ/"
                    >
                      <span class="overlay">
                        <span class="d-title"
                          >Dokumentasi Hajimari no Recreate</span
                        >
                      </span>

                      <img src="{{ asset('images/portfolio/crehaprojects.jpg') }}" alt="" />
                    </a>
                  </div>
                  ...
                  <div
                    class="item col-md-4 mb30 gallery-item videography undiksha"
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/portfolio/ptividprofil.png') }}"
                      title="Produksi Video Profil Prodi di Undiksha"
                      data-source="https://www.youtube.com/watch?v=vAHPyN2ddnw&t=41s"
                    >
                      <span class="overlay">
                        <span class="d-title"
                          >Produksi Video Profil S1 PTI Undiksha</span
                        >
                      </span>

                      <img src="{{ asset('images/portfolio/ptividprofil.png') }}" alt="" />
                    </a>
                  </div>
                  ...
                  <div class="item col-md-4 mb30 gallery-item undiksha">
                    <a
                      class="picframe"
                      href="{{ asset('images/portfolio/tnku.jpeg') }}"
                      title="TenunKu"
                      data-source="https://gungmichael.my.id/tenunku "
                    >
                      <span class="overlay">
                        <span class="d-title">TenunKu</span>
                      </span>

                      <img src="{{ asset('images/portfolio/tnku.jpeg') }}" alt="" />
                    </a>
                  </div>
                  ...
                  <div class="item col-md-4 mb30 gallery-item undiksha">
                    <a
                      class="picframe"
                      href="{{ asset('images/portfolio/ftq_game.jpeg') }}"
                      title="Fight The Question Games"
                      data-source="# "
                    >
                      <span class="overlay">
                        <span class="d-title">Fight The Question Games</span>
                      </span>

                      <img src="{{ asset('images/portfolio/ftq_game.jpeg') }}" alt="" />
                    </a>
                  </div>

                  <div class="item col-md-4 mb30 gallery-item videography">
                    <a
                      class="picframe"
                      href="{{ asset('images/portfolio/talkshow.png') }}"
                      title="Talkshow Edukasi COVID-19"
                      data-source="https://www.youtube.com/playlist?list=PL-lm8ezwTkPnMvJSLjJdoxtOkBxV2M6ay"
                    >
                      <span class="overlay">
                        <span class="d-title">Talkshow Edukasi COVID-19</span>
                      </span>

                      <img
                        src="{{ asset('images/portfolio/talkshow.png') }}"
                        alt="Talkshow Edukasi COVID-19"
                      />
                    </a>
                  </div>

                  <div class="item col-md-4 mb30 gallery-item motion">
                    <a
                      class="picframe"
                      href="{{ asset('images/portfolio/motiongraphics.png') }}"
                      title="Motion Graphics Edukasi COVID-19"
                      data-source="https://www.youtube.com/playlist?list=PL-lm8ezwTkPnKQxZSqRwUILNIYiE2RdNn"
                    >
                      <span class="overlay">
                        <span class="d-title"
                          >Motion Graphics Edukasi COVID-19</span
                        >
                      </span>

                      <img
                        src="{{ asset('images/portfolio/motiongraphics.png') }}"
                        alt="Motion Graphics Edukasi COVID-19"
                      />
                    </a>
                  </div>
                  ...
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/portfolio/bsmpt.png') }}"
                      title="Bismapati (Bincang Bersama PTI)"
                      data-source="https://www.youtube.com/playlist?list=PL6PZBIekQVMtTyKaDTtIEbImmvphon6Cp"
                    >
                      <span class="overlay">
                        <span class="d-title"
                          >Bismapati (Bincang Bersama PTI)</span
                        >
                      </span>

                      <img
                        src="{{ asset('images/portfolio/bsmpt.png') }}"
                        alt="Bismapati (Bincang Bersama PTI)"
                      />
                    </a>
                  </div>
                  ...
                  <div class="item col-md-4 mb30 gallery-item photography">
                    <a
                      class="picframe"
                      href="{{ asset('images/portfolio/yeyo.jpg') }}"
                      title="Yeolyora no Matsuri 1"
                      data-source="https://link.gungmichael.my.id/kamekobali"
                    >
                      <span class="overlay">
                        <span class="d-title">Yeolyora no Matsuri 1</span>
                      </span>

                      <img
                        src="{{ asset('images/portfolio/yeyo.jpg') }}"
                        alt="Yeolyora no Matsuri 1"
                      />
                    </a>
                  </div>
                  ...
                  <div class="item col-md-4 mb30 gallery-item photography">
                    <a
                      class="picframe"
                      href="{{ asset('images/portfolio/wibupp2.jpeg') }}"
                      title="Cosu Toori"
                      data-source="https://link.gungmichael.my.id/kamekobali"
                    >
                      <span class="overlay">
                        <span class="d-title">Cosu Toori</span>
                      </span>

                      <img
                        src="{{ asset('images/portfolio/wibupp2.jpeg') }}"
                        alt="Cosu Toori"
                      />
                    </a>
                  </div>
                  ...
                  <div class="item col-md-4 mb30 gallery-item photography">
                    <a
                      class="picframe"
                      href="{{ asset('images/updateport/yeyo2.jpeg') }}"
                      title="Yeolyora no Matsuri 2"
                      data-source="https://link.gungmichael.my.id/kamekobali"
                    >
                      <span class="overlay">
                        <span class="d-title">Yeolyora no Matsuri 2</span>
                      </span>

                      <img
                        src="{{ asset('images/updateport/yeyo2.jpeg') }}"
                        alt="Yeolyora no Matsuri 2"
                      />
                    </a>
                  </div>

                  <div
                    class="item col-md-4 mb30 gallery-item videography photography"
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/updateport/arabian styles.jpeg') }}"
                      title="Arabian Styles"
                      data-source="# "
                    >
                      <span class="overlay">
                        <span class="d-title">Arabian Styles</span>
                      </span>

                      <img
                        src="{{ asset('images/updateport/arabian styles.jpeg') }}"
                        alt="Arabian Styles"
                      />
                    </a>
                  </div>
                  ...
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/updateport/skripsi PVSK.jpeg') }}"
                      title="Pembuatan Media Ajar Video"
                      data-source="# "
                    >
                      <span class="overlay">
                        <span class="d-title">Pembuatan Media Ajar Video</span>
                      </span>

                      <img
                        src="{{ asset('images/updateport/skripsi PVSK.jpeg') }}"
                        alt="Pembuatan Media Ajar Video"
                      />
                    </a>
                  </div>
                  ...
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/updateport/kedaireka matching fund.jpeg') }}"
                      title="Editing Video Matching Fund"
                      data-source="https://www.youtube.com/watch?v=sPWMXZDnRVU"
                    >
                      <span class="overlay">
                        <span class="d-title">Pembuatan Media Ajar Video</span>
                      </span>
                      ...
                      <img
                        src="{{ asset('images/updateport/kedaireka matching fund.jpeg') }}"
                        alt="Editing Video Matching Fund"
                      />
                    </a>
                  </div>
                  ...
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/updateport/litdig.jpeg') }}"
                      title="Teknis Literasi Digital Singaraja 2023"
                      data-source="# "
                    >
                      <span class="overlay">
                        <span class="d-title"
                          >Teknis Literasi Digital Singaraja 2023</span
                        >
                      </span>

                      <img
                        src="{{ asset('images/updateport/litdig.jpeg') }}"
                        alt="Teknis Literasi Digital Singaraja 2023"
                      />
                    </a>
                  </div>
                  ...
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/updateport/s2 bhs inggris.jpeg') }}"
                      title="Video Profile S2 Bahasa Inggris"
                      data-source="# "
                    >
                      <span class="overlay">
                        <span class="d-title"
                          >Video Profile S2 Bahasa Inggris</span
                        >
                      </span>

                      <img
                        src="{{ asset('images/updateport/s2 bhs inggris.jpeg') }}"
                        alt="Video Profile S2 Bahasa Inggris"
                      />
                    </a>
                  </div>
                  ...
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/updateport/wib 1.jpeg') }}"
                      title="Waktu Infinity Berbincang 1"
                      data-source="https://www.youtube.com/watch?v=AyGu5LWC-QI"
                    >
                      <span class="overlay">
                        <span class="d-title">Waktu Infinity Berbincang 1</span>
                      </span>

                      <img
                        src="{{ asset('images/updateport/wib 1.jpeg') }}"
                        alt="Waktu Infinity Berbincang 1"
                      />
                    </a>
                  </div>
                  ...
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/updateport/uas pkk.jpeg') }}"
                      title="UAS Tata Kecantikan PKK Undiksha"
                      data-source="# "
                    >
                      <span class="overlay">
                        <span class="d-title"
                          >UAS Tata Kecantikan PKK Undiksha</span
                        >
                      </span>

                      <img
                        src="{{ asset('images/updateport/uas pkk.jpeg') }}"
                        alt="UAS Tata Kecantikan PKK Undiksha"
                      />
                    </a>
                  </div>
                  ...
                  <div class="item col-md-4 mb30 gallery-item photography">
                    <a
                      class="picframe"
                      href="{{ asset('images/updateport/natsu matsuri.jpeg') }}"
                      title="Natsu Matsuri by Encore"
                      data-source="https://link.gungmichael.my.id/kamekobali"
                    >
                      <span class="overlay">
                        <span class="d-title">Natsu Matsuri by Encore</span>
                      </span>

                      <img
                        src="{{ asset('images/updateport/natsu matsuri.jpeg') }}"
                        alt="Natsu Matsuri by Encore"
                      />
                    </a>
                  </div>
                  ...
                  >
                    <a
                      class="picframe"
                      href="{{ asset('images/updateport/Screenshot (84).png') }}"
                      title="Video Profile S2 Akuntansi Undiksha"
                      data-source="https://www.youtube.com/watch?v=pifGTqgyiV0"
                    >
                      <span class="overlay">
                        <span class="d-title"
                          >Video Profile S2 Akuntansi Undiksha</span
                        >
                      </span>

                      <img
                        src="{{ asset('images/updateport/Screenshot (84).png') }}"
                        alt="Video Profile S2 Akuntansi Undiksha"
                      />
                    </a>
                  </div>
                ...
                @foreach($blog as $blogs)
                    <div class="post-content">
                        <div class="post-image d-hover-zoom">
                            <a class="image-popup" href="{{ asset($blogs->image_path) }}">
                                <img alt="" src="{{ asset($blogs->image_path) }}" />
                            </a>

                            <div class="post-info">
                                <div class="inner">
                                    <span class="post-date">{{ $blogs->created_at->format('d M Y') }}</span>
                                </div>
                            </div>
                        </div>

                        <div class="post-text">
                            <h4><a href="{{ route('posts.show', $blogs->id) }}">{{ $blogs->title }}</a></h4>
                            <p><b>Written by </b>{{ $blogs->author }}</p>
                            <p>{{ Str::limit($blogs->content, $limit = 200, $end = '...') }}</p>
                        </div>
                    </div>
                @endforeach
              </div>
